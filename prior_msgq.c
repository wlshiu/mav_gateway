    ...
    void            *pMsg_data)
{
    ...
    do{
        ...
        err_msg("  node_idx_w = %d, pNew_node=0x%x, ptr=0x%x\n",
                pDev->node_idx_w, pNew_node, pDev->ppNode_list[pDev->node_idx_w]);
    ...
    void            **ppMsg_data)
{
    ...
    do{
        ...
        // pop from list
        err_msg("  node_idx_r = %d, ptr=0x%x\n", pDev->node_idx_r, pDev->ppNode_list[pDev->node_idx_r]);
